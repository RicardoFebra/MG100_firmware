...
#define GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1 0x0088
#define GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID2 0x00F5
...
#define SENSOR_AD_HEADER_SIZE_VIBBOARD 2
/* Bytes used to differentiate advertisement types/sensors. */
extern const uint8_t VIBBOARD_AD_HEADER[SENSOR_AD_HEADER_SIZE_VIBBOARD];
extern const uint8_t VIBBOARD_RSP_HEADER[SENSOR_AD_HEADER_SIZE_VIBBOARD];
extern const uint8_t VIBBOARD_CODED_HEADER[SENSOR_AD_HEADER_SIZE_VIBBOARD];
