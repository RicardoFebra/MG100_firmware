...
const uint8_t BT510_AD_HEADER[SENSOR_AD_HEADER_SIZE] = {
	LSB_16(GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
	MSB_16(GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
...
const uint8_t BT510_RSP_HEADER[SENSOR_AD_HEADER_SIZE] = {
	LSB_16(GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID2),
	MSB_16(GENOA_SPARK_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID2),
...
/******************************************************************************/
/* Vib sensor Definition	                                                  */
/******************************************************************************/
const uint8_t VIBBOARD_AD_HEADER[SENSOR_AD_HEADER_SIZE] = {
	LSB_16(LAIRD_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
	MSB_16(LAIRD_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
	LSB_16(BT510_1M_PHY_AD_PROTOCOL_ID), MSB_16(BT510_1M_PHY_AD_PROTOCOL_ID)
};

const uint8_t VIBBOARD_RSP_HEADER[SENSOR_AD_HEADER_SIZE] = {
...
const uint8_t VIBBOARD_CODED_HEADER[SENSOR_AD_HEADER_SIZE] = {
	LSB_16(LAIRD_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
	MSB_16(LAIRD_CONNECTIVITY_MANUFACTURER_SPECIFIC_COMPANY_ID1),
	LSB_16(BT510_CODED_PHY_AD_PROTOCOL_ID),
	MSB_16(BT510_CODED_PHY_AD_PROTOCOL_ID)
